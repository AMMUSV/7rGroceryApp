...
public class Constant {
	...
	public static final String ERRORMESSAGE_SIGNINBUTTON = "Text displayed is not as ecpected";
	public static final String ERRORMESSAGE_ONCHECKBOX = "REmemberMe Checkbox is not seleceted";
	public static final String USERNAME = "admin";
	public static final String PASSWORD = "admin";
	public static final String ERRORMESSAGE_FOREWRONGURL = "URL got is not as expeceted";
	public static final String ERRORMESSAGE_SELECTIONOFRADIOBUTTON = "ManageExpense button is not slected";
	public static final String ERRORMESSAGE_ONCREDITCASHELEMENT = "The credit cash of odercash is not as expected";
	...
	public static final String ERRORMESSAGE_TITLE_TEXT = "the text of title is not as expected";
	public static final String ERRORMESSAGE_MANAAGEPRODUCTS_PLACEHOLDER_TEXT = "Placeholder text of Title field is not as expected";
	public static final String ERRORMESSAGE_MANAGEUSERS_STATUSOF_NEENA="Status of neena is not as expected";
	public static final String ERRORMESSAGE_MANAGAESLIDERSPAGE_SAVEDDATA="The saved data is not present";
	public static final String ERRORMESSAGE_LISTPAGES_ALERT_STRING="Alert is not present";
